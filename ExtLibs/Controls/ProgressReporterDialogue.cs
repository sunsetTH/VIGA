...
namespace MissionPlanner.Controls
{
    ...
    public partial class ProgressReporterDialogue : Form
    {
        ...
        private void RunBackgroundOperation(object o)
        {
            ...
            {
                ShowDoneWithError(null, "操作暂时无法取消！");
                Running = false;
                return;
            }
        ...
        {
            var errMessage = doWorkArgs ?? "系统发生错误，检查后重试！";
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            CustomMessageBox.Show(message,"异常详情",MessageBoxButtons.OK,MessageBoxIcon.Information);
        }
