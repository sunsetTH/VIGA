        ...
        void doPaint(PaintEventArgs e)
        {
            ...
            try
            {
                ...
                if (bgon == true)
                {
                    ...
                    if (bg.Height != 0)
                    {
                        using (LinearGradientBrush linearBrush = new LinearGradientBrush(
                            bg, Color.RoyalBlue, Color.SteelBlue, LinearGradientMode.Vertical))
                        {
                    ...
                    if (bg.Height != 0)
                    {
                        using (
                            LinearGradientBrush linearBrush = new LinearGradientBrush(
                                 bg, Color.FromArgb(205, 133, 0), Color.FromArgb(139, 90, 0), LinearGradientMode.Vertical))
                        {
                            graphicsObject.FillRectangle(linearBrush, bg);
                        }
                    }
                ...
                if (status == false) // not armed
                {
                    ...
                    {
                        drawstring(graphicsObject, HUDT.DISARMED, font, fontsize + 10, (SolidBrush)Brushes.ForestGreen, -40, halfheight / -3+20);
                        statuslast = status;
                    }
                }
                else if (status == true) // armed
                {
                    if ((armedtimer.AddSeconds(8) > DateTime.Now))
                    {
                        drawstring(graphicsObject, HUDT.ARMED, font, fontsize + 20, (SolidBrush)Brushes.Green, -40, halfheight / -3+20);
                        statuslast = status;
                    }
                }
