...
namespace MissionPlanner
{
    public static class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            if (File.Exists(Settings.GetRunningDirectory() + "viga.png"))
                Logo = new Bitmap(Settings.GetRunningDirectory() + "viga.png");

            if (File.Exists(Settings.GetRunningDirectory() + "viga.png"))
            {
                // 128*128
                IconFile = new Bitmap(Settings.GetRunningDirectory() + "viga.png");
            }
            else
            {
                IconFile = MissionPlanner.Properties.Resources.icon.ToBitmap();
            }

            if (File.Exists(Settings.GetRunningDirectory() + "vigabg.png")) // 600*375
                SplashBG = new Bitmap(Settings.GetRunningDirectory() + "vigabg.png");
